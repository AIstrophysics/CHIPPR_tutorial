...
from pomegranate.distributions import Normal as ND
...
class gauss(object):
    ...
    def __init__(self, mean, var, bounds=None):
        ...
        # Ensure var is converted to a 2D covariance matrix
        self.var = np.atleast_1d(var)  # Convert to 1D array if scalar
